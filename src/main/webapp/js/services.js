 ...
 * return $resource('http://localhost:8080/clients', {}, { query : { method :
 * 'GET', isArray : false, }, create : { method : 'POST' } }); } ]);
 * 
 ...
 * return $resource('http://localhost:8080/incomes/:incomeId', {}, { show : {
 * method : 'GET', isArray : false }, update : { method : 'PUT', params : {
 * clientId : '@incomeId' } }, remove : { method : 'DELETE' } }); } ]);
 */